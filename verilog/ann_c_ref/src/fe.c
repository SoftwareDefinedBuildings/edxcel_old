...
void printfe(fe v) {
	fprintf(stderr, "(FE [0]=%08x [1]=%08x [2]=%08x [3]=%08x [4]=%08x [5]=%08x [6]=%08x [7]=%08x [8]=%08x [9]=%08x)",
...
static uint64_t load_3(const unsigned char *in) {
	...
	fprintf(stderr, "fe.load3 in[0..11]=(%02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x) out=(%16x)\n",
			in[0],in[1],in[2],in[3],in[4],in[5],in[6],in[7],in[8],in[9],in[10],in[11],result);
    return result;
}
...
static uint64_t load_4(const unsigned char *in) {
    ...
    fprintf(stderr, "fe.load4 in[0..12]=(%02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x) out=(%16x)\n",
			in[0],in[1],in[2],in[3],in[4],in[5],in[6],in[7],in[8],in[9],in[10],in[11],in[12],result);
    return result;
}
