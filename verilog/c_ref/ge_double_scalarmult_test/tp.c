...
#endif
    uint8_t sig32_arr [] =
{ 0xf2 , 0xff , 0xdf , 0xff , 0x9e , 0x00 , 0x6a , 0x0b , 0x83 , 0x9e , 0x2e , 0x5c , 0x79 , 0x61 , 0x2a , 0xcf , 0x50 , 0xf9 , 0xab , 0xe3 , 0xa3 , 0x9d , 0xa4 , 0x4f , 0x86 , 0x5f , 0xb4 , 0x30 , 0x6c , 0xbd , 0x15 , 0x17 , 0x2b , 0x02 , 0xfc , 0x33 , 0x41 , 0x41 , 0xf6 , 0xce , 0xdf , 0x44 , 0xc3 , 0xde , 0xdd , 0x2a , 0x26 , 0x22 , 0x79 , 0x4e , 0x42 , 0x92 , 0xf5 , 0x62 , 0xe3 , 0xd9 , 0x3f , 0x12 , 0x46 , 0x7a , 0x65 , 0x2c , 0x72 , 0x0e };
...
//{ 0x83 , 0x45 , 0xdf , 0x01 , 0x44 , 0x4b , 0xf5 , 0x00 , 0xe8 , 0x72 , 0xe1 , 0xfe , 0x7e , 0x97 , 0xb2 , 0x00 , 0x78 , 0x19 , 0x2b , 0xff , 0xe0 , 0x17 , 0xbd , 0xff , 0x13 , 0x05 , 0x67 , 0xfe , 0x56 , 0x46 , 0x58 , 0x00 , 0x38 , 0x61 , 0x9a , 0xff , 0x59 , 0xb6 , 0x90 , 0xff };
    ...
    fe a_x; memcpy(&a_x, &a_x_arr[0], 40);
   	fe a_y; memcpy(&a_y, &a_y_arr[0], 40);
   	fe a_z; memcpy(&a_z, &a_z_arr[0], 40);
   	fe a_t; memcpy(&a_t, &a_t_arr[0], 40);
   ...
   //	uint8_t sig32_arr [] = { 0x38 , 0x51 , 0xd5 , 0x60 , 0x69 , 0xf2 , 0x38 , 0xf0 , 0x30 , 0x97 , 0xeb , 0xfe , 0xf9 , 0xac , 0x3b , 0xcf , 0x27 , 0x18 , 0x43 , 0xe4 , 0x84 , 0x32 , 0x78 , 0x02 , 0x3c , 0x30 , 0x61 , 0x39 , 0xb9 , 0x1f , 0x0b , 0x06 };
    ...
    //ge_double_scalarmult_vartime(&R, h_arr, &A, sig32_arr);
    /*printf("r_x:  ");
    for (i=320/8 - 1; i>= 0; i--)
    {
    ...
    //printf("\n");
    ge_double_scalarmult_vartimep(r_X,r_Y,r_Z,h_arr,a_x,a_y,a_z,a_t,sig32_arr+32);
   /* printf("r_x:  ");
    for (i=320/8 - 1; i>= 0; i--)
    {
